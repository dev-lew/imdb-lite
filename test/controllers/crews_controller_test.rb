...
class CrewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create crew" do
    assert_difference('Crew.count') do
      post crews_url, params: { crew: { directors: @crew.directors, tconst: @crew.tconst, writers: @crew.writers } }
    end
  ...
  test "should update crew" do
    patch crew_url(@crew), params: { crew: { directors: @crew.directors, tconst: @crew.tconst, writers: @crew.writers } }
